package br.com.project.portfolio.mock.member.api.config;
...
public class SwaggerConfig {
    ...
    public static final String APP_TITLE = "Project Portfolio API - MEMBERS API";
    public static final String APP_VERSION = "1.0";
    public static final String APP_DESCRIPTION = "Project Portfolio API - MEMBERS API";
    ...
    public static final String BASE_PACKAGE = "br.com.project.portfolio.mock.member.api";
