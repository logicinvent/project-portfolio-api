...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ApiError> handle(MemberNotFoundException ex, HttpServletRequest req) {
        return build(HttpStatus.NOT_FOUND, ex.getMessage(), req, null);
    }

    @ExceptionHandler(MemberFoundInProjectException.class)
    public ResponseEntity<ApiError> handle(MemberFoundInProjectException ex, HttpServletRequest req) {
        return build(HttpStatus.NOT_FOUND, ex.getMessage(), req, null);
    }

    @ExceptionHandler(NotPermittedException.class)
    public ResponseEntity<ApiError> handle(NotPermittedException ex, HttpServletRequest req) {
        return build(HttpStatus.CONFLICT, ex.getMessage(), req, null);
    }

    @ExceptionHandler(ProjectNotFoundException.class)
    public ResponseEntity<ApiError> handle(ProjectNotFoundException ex, HttpServletRequest req) {
        return build(HttpStatus.NOT_FOUND, ex.getMessage(), req, null);
    }

    @ExceptionHandler(TotalMaxExceededException.class)
    public ResponseEntity<ApiError> handle(TotalMaxExceededException ex, HttpServletRequest req) {
        return build(HttpStatus.NOT_FOUND, ex.getMessage(), req, null);
    }
    ...
    public ResponseEntity<ApiError> handleConstraintViolation(ConstraintViolationException ex,
                                                              HttpServletRequest req) {
        List<ApiError.FieldErrorDetail> fields = ex.getConstraintViolations().stream()
